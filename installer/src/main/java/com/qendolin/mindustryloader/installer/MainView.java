...
public class MainView extends JFrame {
    ...
    private JCheckBox latestVersionCheckBox;
    ...
    public MainView() {
        ...
        installButton.addActionListener(ev -> {
            ...
            boolean fetchLatestVersion = latestVersionCheckBox.isSelected();
            install(gameDirectory, fetchLatestVersion);
        });
    }
    ...
    private void install(Path gameDir, boolean fetchLatestVersion) {
        try {
            Installer i = new Installer(gameDir.toString(), fetchLatestVersion);
            i.onLog = this::log;
...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        footer = new JPanel();
        footer.setLayout(new GridLayoutManager(1, 4, new Insets(0, 0, 0, 0), -1, -1));
        root.add(footer, BorderLayout.SOUTH);
        installButton = new JButton();
        installButton.setText("Install");
        footer.add(installButton, new GridConstraints(0, 3, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        cancelButton = new JButton();
        cancelButton.setText("Cancel");
        footer.add(cancelButton, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        latestVersionCheckBox = new JCheckBox();
        latestVersionCheckBox.setSelected(true);
        latestVersionCheckBox.setText("Latest Version");
        footer.add(latestVersionCheckBox, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
        final Spacer spacer1 = new Spacer();
        footer.add(spacer1, new GridConstraints(0, 1, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, 1, null, null, null, 0, false));
        main = new JPanel();
